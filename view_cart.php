...
<div class="viewcart">
	...
	if(isset($_SESSION["cart_session"]))
    {
		...
		echo '<spa class="midigta"><a  class="a-btn" href="Somstore checkout/zaadprocess.php"><span class="a-btn-text">Proced On cart</span> </a></span>';
		
		echo '<span class="midigta"> <a  class="a-btn" href="Somstore checkout/process.php"> <span class="a-btn-text"> Pay On 	cart</span></a></span>';
		echo '</span>';
		echo '</form>'; 
