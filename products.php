					...
					<li class="widget">
						...
						<div class="brands">
							<ul>
								...
								<li><a href="warehouse_2.php" title="Brand 2"><img src="images/b.jpg" width="103" height="51" alt="Brand 2" /></a></li>
		...
		<div id="footer">
			...
			<div class="copy">
				...
				<div class="shell">
					...
					<div class="cl">&nbsp;</div>
					Copyright © 2018 NovaShop.com All rights reserved. The information contained in NovaShop.com may not be published, broadcast, rewritten, or redistributed without the prior written authority of NovaShop.com
				</div>
				<!-- End Shell -->
			</div>
		</div>
